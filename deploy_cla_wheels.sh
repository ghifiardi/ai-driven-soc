#!/bin/bash
# CLA Deployment Script - With direct wheel installation
...
cp ~/fixed_requirements.txt ~/ai-driven-soc/requirements.txt
...
# Install wheel files directly
echo "Installing wheel files..."
pip install ~/langgraph-0.5.0-py3-none-any.whl
pip install ~/langgraph_checkpoint-2.1.0-py3-none-any.whl
pip install ~/ormsgpack-1.10.0.tar

# Now install the regular requirements
